        ...
        <div class="ncp-table w-100 d-flex center">
            <table class="w-100">
                ...
                <tr>
                    ...
                    <?php echo is_front_page()||is_page('plans') ? '<td style="display: flex;"><a href="' . site_url() . '/panel/?land=challenge" class="ncp-table-btn">$59</a></td>' : '<td style="display: flex;"><a>$59</a></td>' ?>
